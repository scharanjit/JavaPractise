...
public class Ex11Directoresss {
	
	
	public static void main(String [] args) throws IOException {
		
		File dir11 = new File("dir1ci");
		dir11.mkdir();
		//File file1 = new File(dir11, "file1");
		//file1.createNewFile();
		
		File dir2 = new File("dir2ci");
		dir2.mkdir();
		//File file2 = new File(dir2, "file2");
		//file2.createNewFile();
		
		String [] dirs = {"dir1ci", "dir2ci"};
		
	for (String d : dirs) {
		String path = d;
		
	File file = new File(path, "dir2ci");
	// insert code 2 here  
