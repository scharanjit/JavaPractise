...
int hashCode() - ideally generating the hashCode as part of the constructor and storing it for immediate recall.

Generating the hashCode in the constructor improves performance when looking up beans in HashMap collections. 
...
Normally a java.io.Serializable designation (by implementing the interface) and a serialVersionUID declaration.
